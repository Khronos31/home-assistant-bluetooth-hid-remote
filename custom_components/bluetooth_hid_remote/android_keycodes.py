"""Android KeyEvent constants generated from the AOSP main branch.

Source: android.view.KeyEvent
https://android.googlesource.com/platform/frameworks/base/+/refs/heads/main/core/java/android/view/KeyEvent.java
"""

from typing import Final

ANDROID_KEY_CODES: Final[dict[str, int]] = {
    "UNKNOWN": 0,
    "SOFT_LEFT": 1,
    "SOFT_RIGHT": 2,
    "HOME": 3,
...
ANDROID_KEY_NAMES: Final[dict[int, str]] = {
    code: name for name, code in ANDROID_KEY_CODES.items()
}
